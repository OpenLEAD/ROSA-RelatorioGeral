...
finalização da tarefa (FIGURA). Há, portanto, a necessidade de instrumentar a
...
Os principais requisitos de projeto são robustez, ser submersível (IP69K),
resistência a choque e vibração, e campos magnéticos externos não devem afetar
as medições.
...
%TODO para cada problema colocar a solucao conceitual
 ...
 A pesquisa bibliográfica abordou os seguintes sensores e sistemas para solução
 da detecção de encaixe: sensor de força, sensor de indutivo de proximidade,
 ...
 pesquisa de mercado, que consiste em avaliar produtos de fornecedores que
