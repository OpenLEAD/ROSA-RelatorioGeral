...
Uma reconstrução 3D de superfície consiste na interpretação e combinação de dados, afim de se extrair informações tridimensionais do ambiente. Em ambientes subaquáticos com pouca visibilidade, o sensor recomendado para esse tipo de operação é o sonar. A figura \ref{fig:reconstrucao} exemplifica uma reconstrução 3D de um ambiente aberto, no caso um campus está sendo representado.
%TODO 
\begin{figure}[H]
    \centering
    \includegraphics{figs/reconstrucao.pdf}
    \caption{Exemplo de uma reconstrução da superfície 3D (campus da Faculdade de Freiburg).}
...
\end{figure}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figs/elevationmap}
...
\end{figure}
    ...
    \begin{figure}[h!]
    \centering
    \includegraphics[width=0.4\textwidth]{figs/octree}
...
\end{figure}
    ...
    \begin{figure}[h!]
     \centering
    \includegraphics[width=0.95\textwidth]{figs/free}
...
Os sistemas de potência devem ser analisados tendo em vista a operação convencional e excepcional. Para a operação excepcional, é necessário o uso de cabo para o fornecimento de grande potência, sendo impossibilitado o uso de bateria para esta operação devido à potência de operação da bomba. Vale notar que a potência da bomba e a consequente expessura do cabo de alimentação é primordial para a definição do carretel para esta aplicação.
